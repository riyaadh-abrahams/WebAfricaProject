...
{
    public abstract class WebAfricaProjectWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static WebAfricaProjectWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(WebAfricaProjectWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<WebAfricaProjectDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<WebAfricaProjectDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<WebAfricaProjectDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<WebAfricaProjectDbContext, Task<T>> func)
        {
            T result;
